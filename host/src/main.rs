...
enum Command {
    Tui {
        ...
        #[arg(long, help = "JSON dashboard configuration file")] config: Option<PathBuf>,
        #[arg(long, value_parser = ["ocean", "forest", "amber"], help = "override the configured color theme")] theme: Option<String>,
        #[arg(long, help = "dashboard redraw interval in milliseconds (50-5000)")] refresh_ms: Option<u64>,
    },
